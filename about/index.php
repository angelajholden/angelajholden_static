			...
			<div class="wrap">
				<div class="content_wrap">
					...
					<aside class="inspiration_sidebar animate__animated" data-animation="animate__fadeInUp">
						<figure class="figure">
							<iframe title="How to really learn frontend development" frameborder="0" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen="" src="https://www.youtube.com/embed/_Vracks8RPI" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"></iframe>
						</figure>
					</aside>
				</div>
			</div>
