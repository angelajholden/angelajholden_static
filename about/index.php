...
<body>
	...
	<main id="content" class="main">
		...
		<section class="skills-experience">
			<div class="wrap">
				<figure class="image-with-background animate__animated" data-animation="animate__fadeInUp">
				...
				<div class="text-container animate__animated animate__fast" data-animation="animate__fadeInUp">
				...
				<div class="content_wrap">
					<figure class="figure yt_video animate__animated" data-animation="animate__fadeInUp" data-video-id="KP0dS-Un_8A">
						<div class="yt_video-wrap">
							...
							<img class="yt_thumb" src="https://img.youtube.com/vi/KP0dS-Un_8A/maxresdefault.jpg" alt="Desktop browsers and mobile browsers are not the same">
						</div>
						<figcaption>Desktop browsers and mobile browsers are not the same.</figcaption>
					</figure>
					<figure class="figure yt_video animate__animated animate__fast" data-animation="animate__fadeInUp" data-video-id="EuUYG5kccyA">
						<div class="yt_video-wrap">
							<button type="button" class="play_button" aria-label="Play Video">
								<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" class="ionicon" viewBox="0 0 512 512"><path d="M133 440a35.37 35.37 0 01-17.5-4.67c-12-6.8-19.46-20-19.46-34.33V111c0-14.37 7.46-27.53 19.46-34.33a35.13 35.13 0 0135.77.45l247.85 148.36a36 36 0 010 61l-247.89 148.4A35.5 35.5 0 01133 440z"/></svg>
							</button>
							<img class="yt_thumb" src="https://img.youtube.com/vi/EuUYG5kccyA/maxresdefault.jpg" alt="Before AI I thought my coding days were over.">
						</div>
						<figcaption>Before AI I thought my coding days were over.</figcaption>
					</figure>
					<figure class="figure yt_video animate__animated" data-animation="animate__fadeInUp" data-video-id="fsGHfVmalmU">
						<div class="yt_video-wrap">
							<button type="button" class="play_button" aria-label="Play Video">
								<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" class="ionicon" viewBox="0 0 512 512"><path d="M133 440a35.37 35.37 0 01-17.5-4.67c-12-6.8-19.46-20-19.46-34.33V111c0-14.37 7.46-27.53 19.46-34.33a35.13 35.13 0 0135.77.45l247.85 148.36a36 36 0 010 61l-247.89 148.4A35.5 35.5 0 01133 440z"/></svg>
							</button>
							<img class="yt_thumb" src="https://img.youtube.com/vi/fsGHfVmalmU/maxresdefault.jpg" alt="How are we dealing with SVGs when the content is dynamic?">
						</div>
						<figcaption>How are we dealing with SVGs when the content is dynamic?</figcaption>
					</figure>
				</div>
			</div>
		</section>
		<section class="lawtubers">
			<div class="heading-wrap animate__animated" data-animation="animate__fadeInUp">
			...
			<div class="wrap">
				<article class="lawtuber-item animate__animated" data-animation="animate__fadeInUp">
					<figure class="image">
						<img src="<?php echo BASE_URL; ?>images/emily-d-baker.jpg" alt="alt text goes here">
					</figure>
					<h3 class="tertiary-heading"><a class="link" href="https://www.youtube.com/@TheEmilyDBaker" target="_blank">Emily D. Baker
					...
					<p>Emily D. Baker was a prosecutor in the Los Angeles County District Attorney's office, the largest in the U.S., for over 10 years. She is a popular LawTuber with more than 800k subscribers. Emily was the first lawyer I saw doing legal commentary on YouTube.</p>
				</article>
				<article class="lawtuber-item animate__animated animate__fast" data-animation="animate__fadeInUp">
					<figure class="image">
						<img src="<?php echo BASE_URL; ?>images/attorney-melanie-little.jpg" alt="alt text goes here">
					</figure>
					<h3 class="tertiary-heading"><a class="link" href="https://www.youtube.com/@AttorneyMelanieLittle" target="_blank">Melanie Little
							<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" class="ionicon" viewBox="0 0 512 512"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="48" d="M268 112l144 144-144 144M392 256H100"/></svg>
						</a></h3>
					<p>Attorney Melanie Little is a retired civil litigator in New York state. She has the smartest, funniest chat on YouTube. She runs a tight ship, and I draw a lot of inspiration from her. Melanie's coverage of both Karen Read trials was excellent.</p>
				</article>
				<article class="lawtuber-item animate__animated" data-animation="animate__fadeInUp">
					<figure class="image">
						<img src="<?php echo BASE_URL; ?>images/andrea-burkhart.jpg" alt="alt text goes here">
					</figure>
